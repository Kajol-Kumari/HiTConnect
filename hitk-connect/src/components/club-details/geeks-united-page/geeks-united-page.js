...
import GeeksUnited from './geeks-united/geeks-united'

export default class GeeksUnitedPage extends Component {
  render() {
    return (
      <div>
        <GeeksUnited />
        <div className="hitk-tech-comm-logo">
          <div className="logo">
            <img src="../../images/geeks_united/geeksunited-logo.jpg" alt="hitk-tech-comm-logo" className="club-logo-img"></img>
          </div>
