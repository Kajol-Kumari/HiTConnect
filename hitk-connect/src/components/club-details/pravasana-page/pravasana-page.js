...
import Pravasana from './pravasana/pravasana'

export default class PravasanaPage extends Component {
  render() {
    return (
      <div>
        <Pravasana />
        <div className="hitk-tech-comm-logo">
          <div className="logo">
            <img src="../../images/drama_logo.png" alt="hitk-tech-comm-logo" className="club-logo-img"></img>
          </div>
